...
function main(input, patient_data) {
	...
	// return [input, holy_results, elig_passed, elig_full];
	// return elig_full;
	// return prettify(input, mgist, sgist);
}
